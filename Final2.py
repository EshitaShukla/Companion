...
class LogIn(tk.Frame):      # LogIn page
    ...
    def __init__(self,parent,controller):
        ...
        def give_options():
            ...
            for line in open('acounts.txt','r'):
            ...
            for L1 in L:
                ...
                if username==L1[0] and password==L1[1]:
                    ...
                    L1=Label(self,text="You have been logged in!")
                    L1.grid(row=6)
                    ...
                    L1=Label(self,text="Login unsuccessful")
                    L1.grid(row=6)
...
class Register(tk.Frame):      # LogIn page
    ...
    def __init__(self,parent,controller):
        ...
        def registration():
            ...
            L1=Label(self,text="You have been registered!")
            L1.grid()

        Submit=ttk.Button(self,text="Submit",command=lambda:registration())
        Submit.grid()
